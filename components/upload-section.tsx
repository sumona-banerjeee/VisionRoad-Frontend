...
const API_URL =
	...
	"https://moved-wma-satisfy-sciences.trycloudflare.com/api/v1";
const WS_URL =
	process.env.NEXT_PUBLIC_WS_URL ||
	"wss://moved-wma-satisfy-sciences.trycloudflare.com/api/v1";
	...
	return (
		<Card className="transition-all hover:shadow-lg">
			<CardHeader>
				...
				<CardDescription>
					Select a video file, detection type, and vehicle speed to start
					AI-powered analysis
				</CardDescription>
			</CardHeader>
			<CardContent className="space-y-4">
				<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
					...
					<div className="space-y-2">
						...
						{jsonFile && (
							<p className="text-sm text-muted-foreground">
								Selected: {jsonFile.name} ({(jsonFile.size / 1024).toFixed(2)}{" "}
								KB)
							</p>
						)}
					</div>
